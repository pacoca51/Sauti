...
class DateConditionDataFactory implements ConditionDataFactory<DateConditionData> {
    @NonNull
    @Override
    public Class<DateConditionData> dataClass() {
        return DateConditionData.class;
    }

    @ValidData
    @NonNull
    @Override
    public DateConditionData dummyData() {
        Calendar calendar = Calendar.getInstance();
        calendar.set(Calendar.DAY_OF_MONTH, 2);
        return new DateConditionData(calendar, DateConditionData.Rel.after);
    }
