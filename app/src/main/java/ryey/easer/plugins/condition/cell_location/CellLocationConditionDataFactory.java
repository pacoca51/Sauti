...
class CellLocationConditionDataFactory implements ConditionDataFactory<CellLocationConditionData> {
    @NonNull
    @Override
    public Class<CellLocationConditionData> dataClass() {
        return CellLocationConditionData.class;
    }

    @ValidData
    @NonNull
    @Override
    public CellLocationConditionData dummyData() {
        return new CellLocationConditionData(new String[]{"1-2", "2-3"});
    }
